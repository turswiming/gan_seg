...
skip_training = False
ab_name = "mask_model"  # Name for the ablation study
...
lr_multi = {
    "ours_4additional":     {
        "num_layers": 6,
        "num_hidden": 512,
        "alternate_flow": [[1,True],[4,False]],
        "alternate_mask": [[1,True],[4,True]],
    },
    "ours_3additional":     {
        "num_layers": 6,
        "num_hidden": 512,
        "alternate_flow": [[2,True],[3,False]],
        "alternate_mask": [[2,True],[3,True]],
    },

    "ours_2additional":     {
        "num_layers": 6,
        "num_hidden": 512,
        "alternate_flow": [[3,True],[2,False]],
        "alternate_mask": [[3,True],[2,True]],
    },
    # "ours_1":     {
    #     "num_layers": 8,
    #     "num_hidden": 128,
    #     "alternate_flow": [[1,True],[1,True]],
    #     "alternate_mask": [[1,True],[1,True]],
    # },
}  # Baseline without smoothness

# Color mapping for different configurations
colors = {
    "ours_4additional": "#ff6b6b",    # Red
    "ours_3additional": "#4ecdc4", # Teal
    "ours_2additional": "#45b7d1",   # Blue
    "ours_1additional": "#f39c12",   # Orange
...
for dataset in dataset_list:
    ...
    for key in lr_multi.keys():
        ...
        for i in range(run_times):
            ...
            command_list = [
                "python", "main.py",
                f"--config", "config/ablation_mask.yaml",
                f"log.dir={savepath}",
                f"dataset.name={dataset}",
                f"checkpoint.resume_path={savepath+'/checkpoints/step_8000.pt'}",
                f"model.mask.MLP.num_layers={lr_multi[key]['num_layers']}",
                f"model.mask.MLP.num_hidden={lr_multi[key]['num_hidden']}",
