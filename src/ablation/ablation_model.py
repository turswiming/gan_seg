...
ab_name = "model"  # Name for the ablation study
...
models = {
    "Direct_Tensor":"OptimizedMask",
    "Neural_Mask_Prior":"NMP",
}
smooth_size = 7
# Color mapping for different configurations
colors = {
    "Direct_Tensor": "#ff7f0e",    # Orange
    "Neural_Mask_Prior": "#1f77b4", # Blue
...
for dataset in dataset_list:
    ...
    for key in models.keys():
        for scene_id in scene_ids:
            ...
            command_list = [
                "python", "main.py",
                f"--config", "config/ablation_model.yaml",
                f"log.dir={savepath}",
                f"dataset.name={dataset}",
                f"dataset.KITTISF.fixed_scene_id='{scene_id}'",
                f"model.mask.name={model_name}",
            ]
